                ...
                <div className="grid lg:grid-cols-2" style={{fontFamily: 'Poppins'}}>
                    ...
                    <div className="bg-blueprimary lg:p-24 p-12 lg:text-start text-center z-0 w-full">
                        ...
                        <div className="flex flex-row items-center justify-center">
                            <a href="https://www.spacetv.com.mx/SpaceTV+(1.2.1).dmg"><Button className='bg-orange-500 hover:bg-orange-800 text-white rounded-full px-8 py-6'>DESCARGAR SPACETV+</Button></a>
                        </div>
                    </div>
                </div>
