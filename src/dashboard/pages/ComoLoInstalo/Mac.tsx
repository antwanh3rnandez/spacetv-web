  ...
  return (
    <div className="flex-col md:flex">
      <div className="relative w-full bg-black h-[220px]">
        <HeroPages title="Instalar SpaceTV+ (Mac)"/>
        <div className="relative flex-1 space-y-4 px-6 sm:px-16 md:px-24 lg:px-32 mt-12">
          <div className='my-12'>
            <div className="my-24 2xl:px-32">
                ...
                <div className="grid lg:grid-cols-2" style={{fontFamily: 'Poppins'}}>
                    ...
                    <div className="bg-blueprimary lg:p-24 p-12 lg:text-start text-center z-0 w-full">
                        ...
                        <p className="text-md font-light mb-4">* Descargar la app de SpaceTV+ para Mac OS X desde el botón naranja de aquí abajo.</p>
                        ...
                        <div className="flex flex-row items-center justify-center">
                            <a href="https://www.spacetv.com.mx/SpaceTV+(1.2.1).dmg" target="_blank"><Button className='bg-orange-500 hover:bg-orange-800 text-white rounded-full px-8 py-6'>DESCARGAR SPACETV+</Button></a>
                        </div>
                    </div>
                </div>
            ...
            <div className="my-12 lg:px-48">
                ...
                <em style={{color: 'rgb(3, 169, 244)', fontFamily: 'Playfair Display'}}>SpaceTV+</em>&nbsp;en Mac</h2>
            </div>
